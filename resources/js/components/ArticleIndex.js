...
class ArticleIndex extends Component {
    ...
    componentDidMount () {
        axios.get('/api/react/articles').then(response => {
            this.setState({
    ...
    deleteItem(id) {
        axios.delete(`/api/react/article/delete/${id}`).then(response => {
              ...
              <div className='col-md-8'>
                <div className='card'>
                  ...
                  <div className='card-body'>
                    <Link className='btn btn-primary btn-sm mb-3' to='/react/create'>
                      Create new article
                    </Link>
                                ...
                                <tr key={i}>
                                    ...
                                    <td width="200" className="text-center">
                                        ...
                                        <Link
                                            ...
                                            to={`/react/article/${article.id}`}
                                            >Detail
                                        </Link>
                                        <Link
                                            className='btn btn-success'
                                            to={`/react/article/edit/${article.id}`}
                                            >Edit
                                        </Link>
                                        <button
